...
/* This function tells the library whether UNICODE textValue is generally
...
/* Get the recommended spacing between lines of textValue for this font */
...
/* Get the dimensions of a rendered string of textValue */
extern DECLSPEC int SDLCALL TTF_SizeText(TTF_Font *font, const char *text, int *w, int *h);
extern DECLSPEC int SDLCALL TTF_SizeUTF8(TTF_Font *font, const char *text, int *w, int *h);
extern DECLSPEC int SDLCALL TTF_SizeUNICODE(TTF_Font *font, const Uint16 *text, int *w, int *h);

/* Get the measurement string of textValue without rendering
   e.g. the number of characters that can be rendered before reaching 'measure_width'

   in:
   measure_width - in pixels to measure this textValue
   out:
...
/* Create an 8-bit palettized surface and render the given textValue at
   fast quality with the given font and color.  The 0 pixel is the
   colorkey, giving a transparent background, and the 1 pixel is set
   to the textValue color.
...
/* Create an 8-bit palettized surface and render the given glyph at
   fast quality with the given font and color.  The 0 pixel is the
   colorkey, giving a transparent background, and the 1 pixel is set
   to the textValue color.  The glyph is rendered without any padding or
...
/* Create a 32-bit ARGB surface and render the given textValue at high quality,
...
/* Set Direction and Script to be used for textValue shaping.
