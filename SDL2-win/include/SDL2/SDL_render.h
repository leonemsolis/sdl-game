...
/**
 * GameLoop the given texture rectangle with new pixel data.
 *
...
/**
 * GameLoop a rectangle within a planar YV12 or IYUV texture with new pixel
 * data.
 *
...
/**
 * GameLoop a rectangle within a planar NV12 or NV21 texture with new pixels.
 *
 * You can use SDL_UpdateTexture() as long as your pixel data is a contiguous
...
/**
 * GameLoop the screen with any rendering performed since the previous call.
 *
